...
class ServiceStandardTest < ActionDispatch::IntegrationTest
  test "service standard page has a title, summary and intro" do
    setup_and_visit_example(
      ...
      description: "The Government Service Standard is a set of 14 criteria.",
      details: {
        body: "All public facing transactional services must meet the standard."
      }
    )

    assert page.has_css?(".page-header__title", text: "Government Service Standard"), "No title found"
    assert page.has_css?(".page-header__summary", text: "The Government Service Standard is a set of 14 criteria"), "No description found"
